...
class BatUI():
    ...
    def _main_menu(self):
        ...
        Keeps asking the user for a selection until they enter a valid choice.
        '''
        print("""
            ------------------------------------------
        ...
        return options.get(choice, self._main_menu)
    ...
    def _loan_item(self):
        ...
        if item is None:
            ...
            if choice == 'y':
                ...
                if patron is None:
                    print(
                        "!!! NO SUCH PATRON. CANCELLING LOAN."
                    )
                else:
    ...
    def _return_item(self):
        ...
        if patron is None:
            ...
            for loan in patron._loans:
                print(loan)
                loaned_ids.append(loan._item._id)
