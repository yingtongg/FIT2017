...
class Patron:
    ...
    @staticmethod
    def load_loans(json_record, library_catalogue):
        """
        ...
        for loan_info in json_record:
            ...
            if item is not None:
                ...
                loans.append(Loan(item, due_date))
        return loans
    ...
    def set_new_patron_data(self, patron_id, name, age):
        ...
        to false.
            Args:
                patron_id (int): a unique ID for the patron.
    ...
    def __str__(self):
        ...
        if not (self._gardening_tool_training or self._carpentry_tool_training or
                self._makerspace_training):
